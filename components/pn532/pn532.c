...
static uint8_t pn532response_firmwarevers[] = {0x00, 0xFF, 0x06,
                                               0xFA, 0xD5, 0x03};
...
void pn532_spi_init(pn532_t *obj, uint8_t clk, uint8_t miso, uint8_t mosi,
                    uint8_t ss) {
  obj->_clk = clk;
  obj->_miso = miso;
  obj->_mosi = mosi;
...
bool pn532_sendCommandCheckAck(pn532_t *obj, uint8_t *cmd, uint8_t cmdlen,
                               uint16_t timeout) {
  // write the command
...
*/
/**************************************************************************/
bool pn532_readPassiveTargetID(pn532_t *obj, uint8_t cardbaudrate, uint8_t *uid,
...
*/
/**************************************************************************/
bool pn532_inDataExchange(pn532_t *obj, uint8_t *send, uint8_t sendLength,
  ...
  if (!pn532_sendCommandCheckAck(obj, pn532_packetbuffer, sendLength + 2,
                                 1000)) {
...
*/
/**************************************************************************/
uint8_t pn532_mifareclassic_AuthenticateBlock(pn532_t *obj, uint8_t *uid,
                                              uint8_t uidLen,
  ...
  if (!pn532_sendCommandCheckAck(obj, pn532_packetbuffer, 10 + obj->_uidLen,
                                 1000))
    return 0;
  ...
  // Mifare auth error is technically uint8_t 7: 0x14 but anything other and
  // 0x00 is not good
...
*/
/**************************************************************************/
uint8_t pn532_mifareclassic_ReadDataBlock(pn532_t *obj, uint8_t blockNumber,
                                          uint8_t *data) {
...
*/
/**************************************************************************/
uint8_t pn532_mifareclassic_WriteDataBlock(pn532_t *obj, uint8_t blockNumber,
                                           uint8_t *data) {
...
*/
/**************************************************************************/
uint8_t pn532_mifareclassic_WriteNDEFURI(pn532_t *obj, uint8_t sectorNumber,
  ...
  if (!(pn532_mifareclassic_WriteDataBlock(obj, sectorNumber * 4,
                                           sectorbuffer1)))
    return 0;
  if (!(pn532_mifareclassic_WriteDataBlock(obj, (sectorNumber * 4) + 1,
                                           sectorbuffer2)))
    return 0;
  if (!(pn532_mifareclassic_WriteDataBlock(obj, (sectorNumber * 4) + 2,
                                           sectorbuffer3)))
    return 0;
  if (!(pn532_mifareclassic_WriteDataBlock(obj, (sectorNumber * 4) + 3,
                                           sectorbuffer4)))
    return 0;
...
*/
/**************************************************************************/
uint8_t pn532_mifareultralight_ReadPage(pn532_t *obj, uint8_t page,
                                        uint8_t *buffer) {
  if (page >= 64) {
...
*/
/**************************************************************************/
uint8_t pn532_mifareultralight_WritePage(pn532_t *obj, uint8_t page,
                                         uint8_t *data) {
...
*/
/**************************************************************************/
uint8_t pn532_ntag2xx_WriteNDEFURI(pn532_t *obj, uint8_t uriIdentifier,
  ...
  uint8_t pageHeader[12] = {
      ...
      0xA0, /* The position inside the tag of the lock bytes (upper 4 = page
               address, lower 4 = uint8_t offset) */
...
void pn532_writecommand(pn532_t *obj, uint8_t *cmd, uint8_t cmdlen) {
  ...
  PN532_DEBUG(" %02x %02x %02x %02x %02x %02x", (uint8_t)PN532_PREAMBLE,
              (uint8_t)PN532_PREAMBLE, (uint8_t)PN532_STARTCODE2,
              (uint8_t)cmdlen, (uint8_t)(~cmdlen + 1),
              (uint8_t)PN532_HOSTTOPN532);
